...
class HandPalmar(Hand):
    ...
    def __init__(self, center_point, palm_height):
        ...
        self.width = round(0.81 * palm_height)
    ...
    def pinky(self, theta):
        return (
            round(
                self.base()[0] + (1.42 * self.height * math.cos(theta))),
            round(self.base()[1] + (1.42 * self.height * math.sin(theta)))
        )
    ...
    def pinkybox(self, theta):
        ...
        pinkytl = (pinkytop[0] - 5, pinkytop[1])
        pinkytr = (pinkytop[0] + 5, pinkytop[1])
        pinkybr = (pinkybase[0] + 5, pinkybase[1])
        pinkybl = (pinkybase[0] - 5, pinkybase[1])
    ...
    def ring(self, theta):
        return (
            round(
                self.base()[0] + (1.72 * self.height * math.cos(theta))),
            round(self.base()[1] + (1.72 * self.height * math.sin(theta)))
        )
    ...
    def ringbox(self, theta):
        ...
        ringtl = (ringtop[0] - 5, ringtop[1])
        ringtr = (ringtop[0] + 5, ringtop[1])
        ringbr = (ringbase[0] + 5, ringbase[1])
        ringbl = (ringbase[0] - 5, ringbase[1])
    ...
    def middlebox(self, theta):
        ...
        middletl = (middletop[0] - 5, middletop[1])
        middletr = (middletop[0] + 5, middletop[1])
        middlebr = (middlebase[0] + 5, middlebase[1])
        middlebl = (middlebase[0] - 5, middlebase[1])
    ...
    def index(self, theta):
        return (
            round(
                self.base()[0] + (1.63 * self.height * math.cos(theta))),
            round(self.base()[1] + (1.63 * self.height * math.sin(theta)))
        )
    ...
    def indexbox(self, theta):
        ...
        indextl = (indextop[0] - 5, indextop[1])
        indextr = (indextop[0] + 5, indextop[1])
        indexbr = (indexbase[0] + 5, indexbase[1])
        indexbl = (indexbase[0] - 5, indexbase[1])
    ...
    def thumb(self, theta):
        return (
            round(
                self.base()[0] + (1.18 * self.height * math.cos(theta))),
            round(self.base()[1] + (1.18 * self.height * math.sin(theta)))
        )
